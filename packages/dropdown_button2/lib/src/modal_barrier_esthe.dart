...
class ModalBarrierEsthe extends StatelessWidget {
  /// Creates a widget that blocks user interaction.
  const ModalBarrierEsthe({
    super.key,
    this.color,
...
class AnimatedModalBarrierEsthe extends AnimatedWidget {
  /// Creates a widget that blocks user interaction.
  const AnimatedModalBarrierEsthe({
    super.key,
